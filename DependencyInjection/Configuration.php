            ...
            ->children()
                ->arrayNode('classes')
                    ->children()
                        ...
                        ->arrayNode('managers')
                            ->children()
                                ->scalarNode('login_manager')->defaultValue('JHV\\Bundle\\UserBundle\\Security\\LoginManager')->cannotBeEmpty()->end()
                                ->scalarNode('handler')->defaultValue('JHV\\Bundle\\UserBundle\\Manager\\Handler')->cannotBeEmpty()->end()
                                ->scalarNode('user_manager')->defaultValue('JHV\\Bundle\\UserBundle\\Doctrine\\UserManager')->cannotBeEmpty()->end()
                                ->scalarNode('user_helper')->defaultValue('JHV\\Bundle\\UserBundle\\Manager\\User\\Helper\\UserHelper')->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('util')
                            ->children()
                                ->scalarNode('form_factory')->defaultValue('JHV\\Bundle\\UserBundle\\Form\\Factory\\FormFactory')->cannotBeEmpty()->end()
                                ->scalarNode('canonicalizer')->defaultValue('JHV\\Bundle\\UserBundle\\Util\\Canonicalizer')->cannotBeEmpty()->end()
                                ->scalarNode('router')->defaultValue('JHV\\Bundle\\UserBundle\\Routing\\RouterLoader')->cannotBeEmpty()->end()
                                ->scalarNode('mailer')->defaultValue('JHV\\Bundle\\UserBundle\\Mailer\\Mailer')->cannotBeEmpty()->end()
                                ->scalarNode('validator')->defaultValue('JHV\\Bundle\\UserBundle\\Validator\\Initializer')->cannotBeEmpty()->end()
                            ->end()
                            ->addDefaultsIfNotSet()
                        ->end()
                        ...
                        ->arrayNode('providers')
                            ->children()
                                ->scalarNode('auth_by_username')->defaultValue('JHV\\Bundle\\UserBundle\\Security\\Provider\\UserProvider')->cannotBeEmpty()->end()
                                ->scalarNode('auth_by_email')->defaultValue('JHV\\Bundle\\UserBundle\\Security\\Provider\\EmailProvider')->cannotBeEmpty()->end()
                            ->end()
                            ->addDefaultsIfNotSet()
                        ->end()
                    ->end()
            ...
            ->children()
                ->arrayNode('templates')
                    ->children()
                        ...
                        ->arrayNode('classes')
                            ->children()
                                ->scalarNode('manager')->defaultValue('JHV\\Bundle\\UserBundle\\Template\\Manager')->cannotBeEmpty()->end()
                                ->scalarNode('renderer')->defaultValue('JHV\\Bundle\\UserBundle\\Template\\Renderer')->cannotBeEmpty()->end()
                            ->end()
                            ->addDefaultsIfNotSet()
                        ->end()
                    ->end()
    ...
    protected function appendRegistrationSection()
    {
        ...
        $node
            ->children()
                ...
                ->arrayNode('form')
                    ->children()
                        ->scalarNode('name')->defaultValue('jhv_user_registration_form')->cannotBeEmpty()->end()
    ...
    protected function appendResettingSection()
    {
        ...
        $node
            ->children()
                ...
                ->arrayNode('form')
                    ->children()
                        ->scalarNode('name')->defaultValue('jhv_user_resetting_form')->cannotBeEmpty()->end()
    ...
    protected function appendProfileSection()
    {
        ...
        $node
            ->children()
                ...
                ->arrayNode('form')
                    ->children()
                        ->scalarNode('name')->defaultValue('jhv_user_profile_form')->cannotBeEmpty()->end()
    ...
    protected function appendChangePasswordSection()
    {
        ...
        $node
            ->children()
                ...
                ->arrayNode('form')
                    ->children()
                        ->scalarNode('name')->defaultValue('jhv_user_change_password_form')->cannotBeEmpty()->end()
